      ...
      <div className="container px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="bg-secondary/50 rounded-xl p-6 border border-border mb-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {features.map((feature, index) => (
              <div key={index} className="bg-card rounded-xl p-5 card-shadow hover:card-shadow-hover border border-border hover:border-accent/20 transition-all duration-300">

export const esTranslations: Record<string, string> = {
  ...
  "calc.infill": "Relleno",
  "calc.qty": "Cant.",
  "calc.infill.15": "15% — ligero / decorativo",
  "calc.infill.30": "30% — estándar",
  "calc.infill.50": "50% — resistente",
  "calc.infill.100": "100% — sólido",
  "calc.analysing": "Analizando…",
  "calc.result.heading": "Precio estimado del pedido",
  "calc.result.disclaimer": "El precio final es revisado y confirmado por una persona real en menos de 1 hora",

export const esTranslations: Record<string, string> = {
  ...
  "hero.cta.getQuote": "Presupuesto gratis al instante",
  ...
  "calc.subtitle": "Sube tus archivos STL — sin cuenta, sin compromiso.",
  "calc.drop": "Suelta tus archivos STL aquí",
  "calc.dropSub": "o haz clic · hasta 20 archivos, máx. 50 MB cada uno",
  "calc.addMore": "Añadir más archivos",
  "calc.maxFiles": "Máximo 20 archivos alcanzado",
  "calc.material": "Material",
  "calc.mat.pla.desc": "calidad, acabado limpio",
  "calc.mat.petg.desc": "resistente, uso general",
  "calc.mat.hips.desc": "ligero, soportes",
  "calc.mat.abs.desc": "duro, mecanizable",
  "calc.mat.asa.desc": "exterior, resistente UV",
  "calc.mat.tpu.desc": "flexible, piezas de goma",
  "calc.mat.nylon.desc": "mecánico, alta resistencia",
  "calc.mat.pc.desc": "impactos, alta temperatura",
  "calc.mat.pva.desc": "soportes solubles en agua",
  "calc.mat.pla-cf.desc": "fibra de carbono, rígido",
  "calc.mat.petg-cf.desc": "fibra de carbono, ligero",
  "calc.mat.nylon-cf.desc": "técnico, ultra-resistente",
  "calc.infill": "Relleno",
  "calc.qty": "Cant.",
  "calc.infill.5":  "5% — ligero / decorativo",
  "calc.infill.15": "15% — estándar",
  "calc.infill.30": "30% — resistente",
  "calc.infill.50": "50% — muy resistente",
  "calc.infill.80": "80% — máximo (muy denso)",
  "calc.analysing": "Analizando…",
  "calc.result.heading": "Precio estimado del pedido",
  "calc.result.disclaimer": "Estimación instantánea — una persona revisará y confirmará tu presupuesto exacto en menos de 1 hora",
  "calc.result.autoNote": "Esta es una estimación automática. Envíanos tu archivo y confirmamos el precio exacto — normalmente en menos de 1 hora.",
  "calc.result.notSentYet.title": "Tu archivo AÚN NO ha sido enviado",
  "calc.result.notSentYet.body": "Introduce tu email o teléfono abajo y pulsa Enviar solicitud de presupuesto — confirmamos el precio exacto normalmente en menos de 1 hora.",
  "calc.modal.title": "Ya casi — un paso más",
  "calc.modal.subtitle": "Introduce tu email o teléfono y confirmamos el precio exacto — normalmente en menos de 1 hora.",
  ...
  "calc.modal.moreFiles": "y {count} archivos más",
  ...
  "calc.result.whatsapp": "Preguntar por WhatsApp",
  "calc.error.parse": "No se pudo leer este archivo STL — comprueba el formato.",
  "calc.error.size": "Archivo demasiado grande (máx. 50 MB)",
  "calc.error.notStl": "Por favor sube un archivo STL (.stl)",
  "calc.error.maxFiles": "Máximo 20 archivos. Elimina uno para añadir otro.",
  "calc.error.filesSkipped": "{n} archivo(s) omitido(s) — el máximo es 20.",
  "calc.reset": "Borrar todo",
  ...
  "calc.walls.2": "2 — estándar",
  "calc.walls.3": "3 — resistente",
  "calc.walls.4": "4 — extra resistente",
  "calc.walls.5": "5 — muy resistente",
  "calc.walls.6": "6 — estructural",
  "calc.walls.7": "7 — alta rigidez",
  "calc.walls.8": "8 — máximo",
  "calc.customize.heading": "Personaliza tu impresión",
  "calc.totalOrder": "Total del pedido",
  "calc.mode.simple": "Simple",
  "calc.mode.advanced": "Avanzado",

  // Quote submission form (inline in calculator)
  "calc.contact.heading": "Obtén tu presupuesto confirmado",
  "calc.contact.email": "Tu email",
  "calc.contact.phone": "WhatsApp / teléfono",
  "calc.contact.atLeastOne": "Introduce al menos un método de contacto — email o teléfono",
  "calc.contact.submit": "Enviar solicitud de presupuesto",
  "calc.contact.submitting": "Subiendo y enviando...",
  "calc.contact.success.title": "¡Solicitud enviada!",
  "calc.contact.success.desc": "Revisaremos tu estimación y confirmaremos el precio exacto en menos de 1 hora.",
  "calc.contact.uploadError": "Error al subir el archivo. Por favor, inténtalo de nuevo.",
  ...
  "calc.contact.reminder": "¿Aún decidiendo? Envíanos tu archivo ahora y confirmamos el precio exacto — sin compromiso.",
  "calc.contact.reminder.close": "Cerrar",
  ...
  "calc.instantBuy.fulfillment.pickup": "Recogida en {city}",
  ...
  "calc.instantBuy.fulfillment.fastPickup": "Recogida el mismo día o al día siguiente posible en {city} para pedidos de PLA, PETG y TPU, según el volumen de pedidos actual.",
  "calc.instantBuy.shipping.print": "Impresión",
  "calc.instantBuy.shipping.surcharge": "Envío",
  "calc.instantBuy.shipping.total": "Total",
  "calc.instantBuy.buyNow": "Comprar ahora — €{price}",
  "calc.instantBuy.manualReview": "Solicitar revisión de nuestro equipo",
  "calc.instantBuy.confirmation": "Confirmación instantánea — listo para imprimir. Sin revisión manual necesaria para este precio.",
  "calc.exitIntent.headline": "¡Espera! Todavía no hemos recibido tu archivo",
  "calc.exitIntent.body": "Déjanos tu email o WhatsApp aquí mismo y revisamos tu pieza personalmente — gratis, sin compromiso.",
  "calc.exitIntent.email": "Tu email",
  "calc.exitIntent.phone": "WhatsApp / teléfono",
  "calc.exitIntent.success": "¡Recibido! Te contactaremos pronto.",
  "calc.exitIntent.cta": "Enviar mis datos",
  "calc.exitIntent.dismiss": "No, gracias",
  "calc.dropzone.noFile": "¿Sin archivo 3D?",
  "calc.dropzone.noFile.cta": "Lo diseñamos desde una foto o tu idea",

  // File Checker
  "checker.meta.title": "¿Tu Archivo 3D Está Listo para Imprimir? Verificador STL Gratis | Dimension3D",
  "checker.meta.description": "Verificador STL gratuito en el navegador. Dimensiones, peso estimado en PLA y evaluación de voladizos en segundos — sin registro, sin subida de archivos al servidor.",
  "checker.badge": "Herramienta gratuita · Sin registro",
  "checker.heading": "¿Tu archivo 3D está listo para imprimir?",
  "checker.subheading": "Sube tu STL — obtén dimensiones, peso estimado y análisis de voladizos al instante. Sin registro. Tu archivo no sale de tu dispositivo.",
  "checker.drop.prompt": "Arrastra tu archivo STL aquí",
  "checker.drop.hint": "o haz clic para seleccionar · solo STL · máx. 250 MB",
  "checker.privacy": "Tu archivo no sale de tu dispositivo — todo el análisis se ejecuta en tu navegador. Nada se sube a ningún servidor.",
  "checker.analyzing": "Analizando…",
  "checker.result.dimensions": "Dimensiones (X × Y × Z)",
  "checker.result.volume": "Volumen estimado",
  "checker.result.weight": "Peso estimado (PLA, 15% relleno)",
  "checker.result.overhangs": "Evaluación de voladizos",
  "checker.overhang.fine": "Probablemente sin soportes",
  "checker.overhang.needsSupport": "Necesitará soportes",
  "checker.overhang.checkOrientation": "Revisa la orientación — muchos voladizos",
  "checker.overhang.disclaimer": "Solo estimación. Basada en normales de cara — las necesidades reales de soporte dependen del laminador y la orientación de impresión.",
  "checker.cta.quote": "¿Listo para imprimir? Obtén un precio al instante",
  "checker.cta.filePrep": "¿El archivo necesita ajustes? Lee la guía de preparación",
  "checker.reset": "Comprobar otro archivo",
  "checker.error.parse": "No se pudo leer el archivo. Asegúrate de que es un STL válido (binario o ASCII).",
  "checker.error.notStl": "Este verificador solo admite archivos STL.",
  "checker.error.tooLarge": "Archivo demasiado grande — máximo 250 MB.",
  "checker.schema.step1.name": "Sube tu archivo STL",
  "checker.schema.step1.text": "Arrastra tu archivo STL al verificador o haz clic para seleccionarlo. Sin cuenta.",
  "checker.schema.step2.name": "Análisis instantáneo en el navegador",
  "checker.schema.step2.text": "La herramienta lee tu archivo localmente — dimensiones, volumen, peso estimado en PLA y porcentaje de voladizos se calculan sin subir nada a ningún servidor.",
  "checker.schema.step3.name": "Revisa los resultados y pide presupuesto",
  "checker.schema.step3.text": "Comprueba las dimensiones, el peso estimado y la evaluación de voladizos. Si el archivo parece correcto, haz clic en Obtén un precio al instante.",

  // WhatsApp
  "whatsapp.tooltip": "¿Hablamos?",
  "whatsapp.message": "Hola, me gustaría solicitar un presupuesto para impresión 3D",
  "whatsapp.float.label": "¿Dudas? Escríbenos",
  ...
  "design.step1.heading": "Cuéntanos qué necesitas",
  "design.step1.desc": "Envía una foto, un boceto o una descripción de la pieza. Cuanto más detalle, mejor — pero incluso un mensaje corto es suficiente para empezar.",
  "design.step2.heading": "Diseñamos y te mostramos cómo quedará",
  "design.step2.desc": "Nuestro equipo modela la pieza con herramientas de visualización 3D para que veas el resultado antes de imprimir nada. Recibes la propuesta y la apruebas.",
  "design.step3.heading": "Apruebas e imprimimos",
  "design.step3.desc": "Una vez das el visto bueno, imprimimos con el material más adecuado. Puedes recoger en Barcelona o te lo enviamos a casa.",
  "design.form.heading": "Cuéntanos qué necesitas",
  "design.form.reassure": "Te respondemos con un presupuesto en menos de 1 hora",
  "design.form.desc.label": "Descripción de la pieza",
  "design.form.desc.placeholder": "¿Qué es la pieza? ¿Para qué sirve? ¿Hay algún detalle de tamaño, forma o función que debamos tener en cuenta?",
  "design.form.photos.label": "Fotos de referencia (opcional)",
  "design.form.photos.hint": "Sube hasta 4 fotos — clic para añadir",
  "design.form.photos.tooLarge": "Algunos archivos superan el límite de 10 MB y no se han añadido.",
  "design.form.dimensions.label": "Dimensiones aproximadas",
  "design.form.dimensions.placeholder": "ej. 10 × 5 × 3 cm",
  "design.form.qty.label": "Cantidad",
  "design.form.qty.placeholder": "1",
  "design.form.contact.heading": "Datos de contacto",
  "design.form.atLeastOne": "Introduce al menos un método de contacto — email o teléfono",
  "design.form.atLeastOne.hint": "Al menos uno de los dos es obligatorio.",
  "design.form.submit": "Enviar solicitud de diseño",
  "design.form.submitting": "Enviando...",
  ...
  "lemon.meta.title": "Impresión 3D en Barcelona — Piezas a Medida | Dimension3D",
  "lemon.meta.desc": "Fabricamos cualquier pieza o accesorio en 3D en Barcelona. Envía una foto, recibe precio en menos de una hora, recógelo o te lo enviamos a casa. Desde 10 €, sin pedido mínimo.",
  ...
  "lemon.steps.2.title": "Recibe el precio",
  "lemon.steps.2.desc": "Normalmente respondemos en menos de una hora, de lunes a sábado.",
  "lemon.steps.3.title": "Recógelo en Barcelona o te lo enviamos",
  "lemon.steps.3.desc": "Recogida en taller sin coste. Envío a domicilio a toda España.",
  "lemon.price.title": "Desde 10 €",
  "lemon.price.subtitle": "Sin pedido mínimo.",
  "lemon.price.desc": "Puedes encargar una sola pieza. Sin importe mínimo ni cantidad mínima.",
  "lemon.examples.title": "Algunos trabajos recientes",
  "lemon.examples.1.alt": "Adaptador de jardín impreso en 3D en Barcelona",
  ...
  "lemon.cta.quote.secondary": "Ya tengo un archivo 3D",
  "lemon.cta.whatsapp.label": "Escríbenos por WhatsApp",
  ...
  "lemon.hero.sub": "Mándanos una foto de lo que necesitas — te respondemos en menos de una hora.",
  "lemon.location": "Taller en Sants, Barcelona · recogida o envío a toda España",
};

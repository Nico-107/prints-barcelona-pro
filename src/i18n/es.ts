export const esTranslations: Record<string, string> = {
  ...
  "calc.exitIntent.headline": "Todavía no hemos recibido tu archivo",
  "calc.exitIntent.body": "Déjanos tu email o teléfono y revisamos tu pieza personalmente — gratis, sin compromiso.",
  "calc.exitIntent.cta": "Enviar un mensaje a nuestro equipo",

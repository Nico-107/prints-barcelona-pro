export const esTranslations: Record<string, string> = {
  ...
  "calc.exitIntent.headline": "Espera — todavía no hemos recibido nada",
  "calc.exitIntent.body": "Si quieres, envíanos un mensaje sobre tu pieza — gratis, sin compromiso",

export const esTranslations: Record<string, string> = {
  ...
  "calc.dropSub": "o haz clic · hasta 10 archivos, máx. 50 MB cada uno",
  "calc.addMore": "Añadir más archivos",
  "calc.maxFiles": "Máximo 10 archivos alcanzado",
  ...
  "calc.error.maxFiles": "Máximo 10 archivos. Elimina uno para añadir otro.",
  "calc.error.filesSkipped": "{n} archivo(s) omitido(s) — el máximo es 10.",

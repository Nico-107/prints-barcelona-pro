export const enTranslations: Record<string, string> = {
  ...
  "calc.dropSub": "or click to browse · up to 10 files, max 50 MB each",
  ...
  "calc.error.maxFiles": "Maximum 10 files. Remove a file to add another.",
  "calc.error.filesSkipped": "{n} file(s) skipped — maximum is 10.",

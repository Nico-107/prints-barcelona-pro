export const enTranslations: Record<string, string> = {
  ...
  "calc.infill": "Infill",
  "calc.qty": "Qty",
  "calc.infill.15": "15% — light / decorative",
  "calc.infill.30": "30% — standard",
  "calc.infill.50": "50% — strong",
  "calc.infill.100": "100% — solid",
  "calc.analysing": "Analysing…",
  "calc.result.heading": "Estimated bundle price",
  "calc.result.disclaimer": "Final price reviewed and confirmed by a real person within 1 hour",

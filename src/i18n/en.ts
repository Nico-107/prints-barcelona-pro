export const enTranslations: Record<string, string> = {
  ...
  "hero.cta.getQuote": "Get a free quote instantly",
  ...
  "calc.subtitle": "Upload your STL files — no account, no commitment.",
  "calc.drop": "Drop your STL files here",
  "calc.dropSub": "or click to browse · up to 20 files, max 50 MB each",
  "calc.addMore": "Add more files",
  "calc.maxFiles": "Maximum 20 files reached",
  ...
  "calc.modal.title": "Almost there — one step left",
  "calc.modal.subtitle": "Enter your email or phone and we'll confirm the exact price — usually within 1 hour.",
  ...
  "calc.result.whatsapp": "Ask on WhatsApp",
  "calc.error.parse": "Could not read this STL file — please check the format.",
  "calc.error.size": "File too large (max 50 MB)",
  "calc.error.notStl": "Please upload an STL file (.stl)",
  "calc.error.maxFiles": "Maximum 20 files. Remove a file to add another.",
  "calc.error.filesSkipped": "{n} file(s) skipped — maximum is 20.",
  "calc.reset": "Clear all",
  "calc.adminTitle": "Price Estimator",
  "calc.admin.weight": "Total weight",
  "calc.admin.hours": "Total print time",
  "calc.admin.filamentCost": "Filament cost (~€0.015/g)",
  "calc.admin.profit": "Est. profit",
  "calc.color": "Color preference",
  "calc.color.placeholder": "e.g. black, white, red, any",

  // Wall loops
  "calc.walls": "Wall loops / perimeters",
  ...
  "calc.contact.email": "Your email",
  "calc.contact.phone": "WhatsApp / phone",
  "calc.contact.atLeastOne": "Enter at least one contact method — email or phone",
  "calc.contact.submit": "Send quote request",
  "calc.contact.submitting": "Uploading & sending...",
  ...
  "calc.multicolour.note": "Multicolour is quoted manually after we review your file.",
  "calc.multicolour.from": "from",
  "calc.overhang.note": "This part may need supports — we'll take care of that when we review your file.",

  // Upload status
  "calc.upload.status.uploading": "Sending your file...",
  "calc.upload.status.slow": "Large file, still uploading — please wait",
  "calc.upload.status.done": "File uploaded successfully",
  "calc.upload.status.failed": "Upload failed — send via WhatsApp",

  "calc.instantBuy.fulfillment.pickup": "Pickup in {city}",
  "calc.instantBuy.fulfillment.shipping": "Shipping",
  "calc.instantBuy.fulfillment.required": "Select pickup or shipping to continue",
  "calc.instantBuy.fulfillment.fastPickup": "Same-day or next-day pickup possible in {city} for PLA, PETG and TPU orders, depending on current order volume.",
  ...
  "calc.instantBuy.confirmation": "Instant confirmation — ready to print. No manual review needed for this price.",
  "calc.exitIntent.headline": "We haven't received your file yet!",
  "calc.exitIntent.body": "Leave your email or WhatsApp number here and we'll review your part and get back to you personally — free, no commitment.",
  "calc.exitIntent.email": "Your email",
  "calc.exitIntent.phone": "WhatsApp / phone",
  "calc.exitIntent.success": "Got it! We'll be in touch soon.",
  "calc.exitIntent.cta": "Send my details",
  ...
  // File Checker
  "checker.meta.title": "Is Your 3D File Ready to Print? Free STL Checker | Dimension3D",
  "checker.meta.description": "Free in-browser STL file checker. Dimensions, estimated PLA weight, and overhang assessment in seconds — no signup, no server upload.",
  "checker.badge": "Free tool · No signup",
  "checker.heading": "Is your 3D file ready to print?",
  "checker.subheading": "Drop your STL — get dimensions, estimated weight and an overhang check instantly. No signup. Your file never leaves your device.",
  "checker.drop.prompt": "Drop your STL file here",
  "checker.drop.hint": "or click to select · STL only · max 250 MB",
  "checker.privacy": "Your file never leaves your device — all analysis runs entirely in your browser. Nothing is uploaded to any server.",
  "checker.analyzing": "Analysing…",
  "checker.result.dimensions": "Dimensions (X × Y × Z)",
  "checker.result.volume": "Estimated volume",
  "checker.result.weight": "Estimated weight (PLA, 15% infill)",
  "checker.result.overhangs": "Overhang assessment",
  "checker.overhang.fine": "Likely fine — few overhangs",
  "checker.overhang.needsSupport": "Will need supports",
  "checker.overhang.checkOrientation": "Check orientation — heavy overhangs",
  "checker.overhang.disclaimer": "Estimate only. Based on face normals — actual support needs depend on slicer settings and print orientation.",
  "checker.cta.quote": "Ready to print this? Get an instant quote",
  "checker.cta.filePrep": "File needs work? Read the preparation guide",
  "checker.reset": "Check another file",
  "checker.error.parse": "Could not read this file. Make sure it is a valid binary or ASCII STL.",
  "checker.error.notStl": "Only STL files are supported by this checker.",
  "checker.error.tooLarge": "File too large — maximum 250 MB.",
  "checker.schema.step1.name": "Drop your STL file",
  "checker.schema.step1.text": "Drag your STL file onto the checker or click to select it. No account needed.",
  "checker.schema.step2.name": "Instant in-browser analysis",
  "checker.schema.step2.text": "The tool reads your file locally — dimensions, volume, estimated PLA weight and overhang percentage are calculated without any server upload.",
  "checker.schema.step3.name": "Review results and get a quote",
  "checker.schema.step3.text": "Check the dimensions, weight estimate and overhang assessment. If the file looks good, click Get an instant quote to price it directly.",
  ...
  "design.step1.heading": "Tell us what you need",
  "design.step1.desc": "Send a photo, sketch, or description of the part. The more detail the better — but even a rough description is enough to get started.",
  "design.step2.heading": "We design it and show you how it'll look",
  "design.step2.desc": "Our team models the part using 3D visualisation tools so you can see exactly how it will look before anything is printed. You review and approve.",
  "design.step3.heading": "You approve and we print",
  "design.step3.desc": "Once you've signed off on the design, we print it in the most suitable material. Pick it up in Barcelona or we ship it to you.",
  "design.form.heading": "Tell us what you need",
  "design.form.reassure": "We'll get back to you with a quote in under 1 hour",
  "design.form.desc.label": "Part description",
  "design.form.desc.placeholder": "What is the part? What does it do? Any specific size, shape, or functional requirements we should know about?",
  "design.form.photos.label": "Reference photos (optional)",
  "design.form.photos.hint": "Upload up to 4 photos — click to add",
  "design.form.photos.tooLarge": "Some files exceed the 10 MB limit and were not added.",
  "design.form.dimensions.label": "Approximate dimensions",
  "design.form.dimensions.placeholder": "e.g. 10 × 5 × 3 cm",
  "design.form.qty.label": "Quantity",
  "design.form.qty.placeholder": "1",
  "design.form.contact.heading": "Contact details",
  "design.form.atLeastOne": "Please provide at least one contact method — email or phone",
  "design.form.atLeastOne.hint": "At least one is required.",
  "design.form.submit": "Send design request",
  "design.form.submitting": "Sending...",
  ...
  "nofile.subheading": "No problem. Describe your idea or upload a photo — we'll design the part for you.",
  "nofile.cta": "Request a custom design",
  ...
  "lemon.meta.title": "3D Printing in Barcelona — Custom Parts on Demand | Dimension3D",
  "lemon.meta.desc": "We make any part or accessory in 3D in Barcelona. Send a photo, get a price within the hour, collect it or have it shipped. From €10, no minimum order.",
  "lemon.hero.title": "Whatever you need, made in 3D.",
  "lemon.hero.subtitle": "A broken part, an accessory you can't find, a one-off piece.",
  "lemon.hero.detail": "Send a photo or a file — get a price within the hour.",
  "lemon.partner": "Recommended by Lemon Printers",
  "lemon.steps.title": "Three steps",
  "lemon.steps.1.title": "Send us a photo, a sketch, or a file",
  "lemon.steps.1.desc": "No technical knowledge needed. A photo of the broken object or where it will fit is enough.",
  "lemon.steps.2.title": "Get a price",
  "lemon.steps.2.desc": "We usually reply within the hour, Monday to Saturday.",
  "lemon.steps.3.title": "Collect in Barcelona or get it shipped",
  "lemon.steps.3.desc": "Free workshop pick-up. Delivery across Spain.",
  "lemon.price.title": "From €10",
  "lemon.price.subtitle": "No minimum order.",
  "lemon.price.desc": "You can order a single piece. No minimum amount or quantity.",
  "lemon.examples.title": "Recent work",
  "lemon.examples.1.alt": "3D printed garden adapter made in Barcelona",
  ...
  "lemon.cta.quote.secondary": "I already have a 3D file",
  "lemon.cta.whatsapp.label": "Message us on WhatsApp",
  "lemon.cta.whatsapp.prefill": "Hi, I'm coming from Lemon Printers and I need a quote.",
  "lemon.trust.reviews": "reviews",
  "lemon.steps.heading": "How it works",
  "lemon.hero.headline": "Whatever you need, made in 3D.",
  "lemon.hero.sub": "Send us a photo of what you need — we usually reply within the hour.",
  "lemon.location": "Workshop in Sants, Barcelona · pickup or shipping across Spain",
};

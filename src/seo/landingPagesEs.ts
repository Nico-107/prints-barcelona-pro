...
export const PAGES_ES: LandingContent[] = [
  ...
  // ----- NUEVA: INGRESOS PARA MAKERS (cómo ganar dinero con una impresora 3D) -----
  {
    ...
    sections: [
      ...
      {
        heading: "Unirte a una red de impresión — la vía más barata a encargos que no perseguiste",
        body: "Una red de impresión es una marca de terceros que ya lleva la parte de marketing — SEO, anuncios, listados, relación con los clientes — y dirige encargos reales a makers en el área local del cliente. Tú conservas tu impresora, trabajas bajo la marca de la red para esos encargos concretos y la red se ocupa del pipeline que en solitario te llevaría años construir.\n\nComo ejemplo concreto, la red de makers de Dimension3D funciona con este modelo. Unirse es gratis — no hay cuota de alta, ni comisión sobre tu trabajo, ni cláusula de exclusividad; sigues vendiendo donde ya vendas. Los makers producen localmente bajo la marca Dimension3D cuando llegan encargos a su zona, así que no estás limitado a una única ciudad. Las condiciones de trabajo se acuerdan individualmente con cada maker antes de empezar cualquier encargo, así que nada se impone de forma genérica. La red se expande ciudad a ciudad, y el número real de encargos que verás depende de la demanda en tu ciudad concreta — un maker en un mercado donde la marca ya está asentada verá más solicitudes que uno en una ciudad donde la red acaba de arrancar.\n\nLo que hace que merezca la pena probar es que unirse no cuesta nada y no hay permanencia. Si funciona en tu ciudad, ganas encargos que no tuviste que marketear. Si aún no, no has perdido nada. Esfuerzo realista: bajo — imprimes, presupuestas y entregas los encargos que aceptas. Tiempo hasta el primer ingreso: depende enteramente de la demanda en tu ciudad. Contra principal: sin garantías, sin volumen prometido — la red aporta el pipeline, pero la demanda es demanda real, no una suscripción.\n\nPara los detalles concretos de cómo funciona — cómo te llegan los encargos, cómo se presupuesta, cómo cobras — mira [/makers](/makers) y [/maker-guide](/maker-guide)."
      }
    ],
    faqs: [
  ...
  // ----- NUEVA: CLIENTES PARA MAKERS (cómo conseguir clientes de impresión 3D) -----
  {
    ...
    sections: [
      ...
      {
        heading: "Unirte a una red existente — encargos que no tuviste que marketear",
        body: "Todo lo anterior merece la pena hagas lo que hagas — pero cada camino necesita tiempo y consistencia antes de producir encargos de forma fiable. Si quieres una vía más corta a peticiones de clientes que no hayas tenido que buscar tú mismo, unirte a una red de impresión ya establecida es la opción de baja fricción que merece la pena considerar.\n\nLa red de makers de Dimension3D funciona así: unirse es gratis (no hay cuota de alta, ni comisión sobre tu trabajo, ni cláusula de exclusividad, así que sigues con cualquier otro canal que ya uses), los makers producen localmente bajo la marca Dimension3D cuando llegan encargos a su zona, y las condiciones de trabajo se acuerdan individualmente con cada maker antes de empezar cualquier encargo. La red se expande ciudad a ciudad, así que el volumen real de peticiones que verás depende de la demanda específica en tu ciudad — un maker en un mercado donde la red ya está asentada verá más solicitudes que uno en una ciudad donde acaba de arrancar.\n\nLa razón por la que merece la pena probarla es simplemente que no cuesta nada unirse y no hay permanencia. Si produce encargos en tu ciudad, ganas un canal que no tuviste que marketear. Si aún no, no has perdido nada y puedes seguir construyendo los canales anteriores. En cualquier caso, complementa — no sustituye — tu propio marketing local.\n\nMira [/makers](/makers) para solicitar y [/maker-guide](/maker-guide) para el recorrido completo de cómo llegan los encargos, cómo se presupuesta y cómo el pago va directamente del cliente al maker."
      }
    ],
    faqs: [

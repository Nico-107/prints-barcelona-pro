...
const routes = ["/", "/track", "/makers", "/maker-guide", "/blog/precio-impresion-3d-barcelona", "/blog/impresion-3d-urgente-barcelona", "/blog/recambios-piezas-rotas-impresion-3d-barcelona", "/privacy", ...ALL_PAGES.map((p) => p.slug)];
